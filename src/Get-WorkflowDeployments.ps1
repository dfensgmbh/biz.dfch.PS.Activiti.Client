function Get-WorkflowDeployments {
<#
.SYNOPSIS
...
id: 				216602
name: 				createTimersProcessUnitTests2.bpmn20.xml
deploymentTime: 	2016-01-21T16:42:56.514+01:00
category: 			null
url: 				http://172.19.115.38:9080/activiti-rest/service/repository/deployments/216602
tenantId: 
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-WorkflowDeployments; } 
